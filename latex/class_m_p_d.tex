...
\item atrributes\-:
\begin{DoxyEnumerate}
\item profiles (mandatory)
\item type (optional, default\-: static)
\item media\-Presentation\-Duration (must be present for static type)
\item min\-Buffer\-Time (mandatory)
\item xmlns
\end{DoxyEnumerate}
\item elements\-:
\begin{DoxyEnumerate}
\item \hyperlink{class_period}{Period} (1...N)
